...
class GitReport(object):
    page_content_placeholder = "<!--PageContent-->"
    middle_li_title_placeholder = "<!--MiddleLI-->"
    middle_li_counter_placeholder = "<!--MiddleCounter-->"
    leaf_content_placeholder = "<!--LeafContent-->"
    project_title_placeholder = "<!--ProjectTitle-->"
    list_counter_placeholder = "<!--ListCounter-->"
    ...
    def generate(self):
        ...
        for project in self.user_info.projects:
            ...
            repo_report = repo_report + self.__project_middle_li.replace(self.middle_li_counter_placeholder,
                                                                         "2").replace(self.middle_li_title_placeholder,
                                                                                      "Challenges/issues:").replace(
                self.list_counter_placeholder, str(list_count)).replace(self.level_counter_placeholder, "1")

            repo_report = repo_report + self.__leaf_content.replace(self.leaf_content_placeholder, "  ")

            repo_report = repo_report + self.__project_middle_li.replace(self.middle_li_counter_placeholder,
                                                                         "3").replace(self.middle_li_title_placeholder,
                                                                                      "Plans:").replace(
                self.list_counter_placeholder, str(list_count)).replace(self.level_counter_placeholder, "1")
        ...
        return report.replace(self.page_content_placeholder, "")
...
mso-list:l0 level2 lfo8'><![if !supportLists]><span style='font-family:Symbol;
mso-fareast-font-family:Symbol;mso-bidi-font-family:Symbol'><span
            style='mso-list:Ignore'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span dir=LTR></span><span style='font-family:
"Arial",sans-serif'>{}<o:p></o:p></span></p>
""".format(leaf_content_placeholder)

    # the ordered item tipically "Achievements"/"Plans"/"Challanges/issues"
    __project_middle_li = """
    <p class=MsoListParagraph style='margin-left:.75in;text-indent:-.25in;
mso-list:l{} level{} lfo{}'><![if !supportLists]><span style='font-size:12.0pt;
font-family:"Arial",sans-serif;mso-fareast-font-family:Arial'><span
            style='mso-list:Ignore'>{}.<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;
</span></span></span><![endif]><span dir=LTR></span><span style='font-family:
"Arial",sans-serif'>{}<o:p></o:p></span></p>
""".format(list_counter_placeholder, level_counter_placeholder, "4", middle_li_counter_placeholder,
           middle_li_title_placeholder)
...
<head>
    ...
    <style>
        ...
        /* List Definitions */
        @list l0 {
            mso-list-id: 35085330;
            mso-list-type: hybrid;
            mso-list-template-ids: 1416371266 1973485152 67698689 67698715 67698703 67698713 67698715 67698703 67698713 67698715;
        }
        @list l0:level1 {
        ...
        @list l3 {
            mso-list-id: 1059400894;
            mso-list-type: hybrid;
            mso-list-template-ids: 1449438110 67698691 67698689 67698693 67698689 67698691 67698693 67698689 67698691 67698693;
        }
        @list l3:level1 {
            mso-level-number-format: bullet;
            mso-level-text: o;
